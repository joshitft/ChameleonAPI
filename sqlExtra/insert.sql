...
(`id` ,`authId` ,`firstName`,`lastName`,`picture`,`gender`,`email`,`cellularNumber`,`country`,`city`,`zipCode`,`industry`,`currentPosition`,`createdAt`,`updatedAt`)
VALUES
("1","user1","f_name1","l_name1","http://www.venmond.com/demo/vendroid/img/avatar/big.jpg","male","user1@yahoo.com","999999991","india","pune","471105","I.T","developer","2018-06-15 03:14:07 ","2018-06-15 03:14:07 "); 

INSERT INTO `chameleon`.`profiles`
(`id` ,`authId` ,`firstName`,`lastName`,`picture`,`gender`,`email`,`cellularNumber`,`country`,`city`,`zipCode`,`industry`,`currentPosition`,`createdAt`,`updatedAt`)
VALUES
("2","user2","f_name2","http://keenthemes.com/preview/metronic/theme/assets/pages/media/profile/profile_user.jpg","l_name2","female","user2@yahoo.com","999999992","nepal","kathmandu","784851","I.T","support","2018-06-15 03:14:07 ","2018-06-15 03:14:07 "); 

INSERT INTO `chameleon`.`profiles`
(`id` ,`authId` ,`firstName`,`lastName`,`picture`,`gender`,`email`,`cellularNumber`,`country`,`city`,`zipCode`,`industry`,`currentPosition`,`createdAt`,`updatedAt`)
VALUES
("3","user3","f_name3","l_name3","http://keenthemes.com/preview/metronic/theme/assets/pages/media/profile/profile_user.jpg","male","user3@yahoo.com","999999993","india","dehradun","248002","Management","HR","2018-06-15 03:14:07 ","2018-06-15 03:14:07 "); 

INSERT INTO `chameleon`.`profiles`
(`id` ,`authId` ,`firstName`,`lastName`,`picture`,`gender`,`email`,`cellularNumber`,`country`,`city`,`zipCode`,`industry`,`currentPosition`,`createdAt`,`updatedAt`)
VALUES
("4","user4","f_name4","l_name4","http://keenthemes.com/preview/metronic/theme/assets/pages/media/profile/profile_user.jpg","female","user4@yahoo.com","999999994","china","fushan","84821","Management","Executive","2018-06-15 03:14:07 ","2018-06-15 03:14:07"); 
